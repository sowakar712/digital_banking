...
class BeneficiaryNGNController extends GetxController {

  String search = "";
  var myList = <BeneficiaryNGNModel>[].obs;
  var page = 1;
  ...
  Future<void> getTask(var page) async {
    try {
      ...
      if (isoffline.value == false) {
        TaskProvider().fetchBeneficiariesNGN(page,search).then((resp) {
          if(resp!=null){
