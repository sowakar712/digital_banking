...
import 'SuccessQRCode.dart';


class SecurePinQRCode extends StatefulWidget {
  const SecurePinQRCode({Key? key}) : super(key: key);

  @override
  State<SecurePinQRCode> createState() => _SecurePinQRCodeState();
}
class _SecurePinQRCodeState extends State<SecurePinQRCode> {
  String pincode="";
  String text = '';
  List<String> OTPText=['','','','','',''];
