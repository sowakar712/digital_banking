...
class QRCodeSuccess extends StatefulWidget {
  QRCodeSuccess({Key? key}) : super(key: key);

  @override
  State<QRCodeSuccess> createState() => _QRCodeSuccessState();
}

class _QRCodeSuccessState extends State<QRCodeSuccess> {
  @override
