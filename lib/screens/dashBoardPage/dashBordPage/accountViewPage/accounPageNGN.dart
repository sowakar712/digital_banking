...
class AccountPageNGN extends StatefulWidget {
  String? AccountName;
  int? AccountNumber;
  String? SortCode;
  String? CurrencyCode;
  AccountPageNGN(this.AccountName,this.AccountNumber,this.CurrencyCode,this.SortCode);

  @override
  State<AccountPageNGN> createState() => _AccountPageNGNState();
}

class _AccountPageNGNState extends State<AccountPageNGN> {
