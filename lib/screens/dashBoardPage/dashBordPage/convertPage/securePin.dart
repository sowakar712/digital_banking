...
class SecurePinConvert extends StatefulWidget {
  const SecurePinConvert({Key? key}) : super(key: key);

  @override
  State<SecurePinConvert> createState() => _SecurePinConvertState();
}

class _SecurePinConvertState extends State<SecurePinConvert> {
  String pincode="";
  String text = '';
  List<String> OTPText=['','','','','',''];
