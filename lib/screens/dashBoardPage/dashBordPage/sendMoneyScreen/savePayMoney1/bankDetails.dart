...
class BankDetails1 extends StatefulWidget {
  String? Name;
  BankDetails1(this.Name);

  @override
  State<BankDetails1> createState() => _BankDetails1State();
}

class _BankDetails1State extends State<BankDetails1> {
              ...
              child: ElevatedButton(
                  ...
                  onPressed: ()  {
                    if (_formKey.currentState!.validate()) {
                      Get.off(SecurePinSavedPayee(widget.Name,amountController.text));
                    }
                  },
                  child: text1(
                      size: 16,
