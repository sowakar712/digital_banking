...
class SuccessSavePay1 extends StatefulWidget {
  String? BName;
  SuccessSavePay1(this.BName);

  @override
  State<SuccessSavePay1> createState() => _SuccessSavePay1State();
}

class _SuccessSavePay1State extends State<SuccessSavePay1> {
  @override
