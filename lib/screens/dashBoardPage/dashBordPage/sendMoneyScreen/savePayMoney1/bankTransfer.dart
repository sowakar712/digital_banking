...
class BankTransfer1 extends StatefulWidget {
  ...
  String? SortCode;
  String? Reference;
  BankTransfer1(this.Name,this.AccountNumber,this.SortCode,this.Reference);
  @override
  State<BankTransfer1> createState() => _BankTransfer1State();
}
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: ()  {
                    print("Hey");
                    Get.off(BankDetails1(widget.Name));
