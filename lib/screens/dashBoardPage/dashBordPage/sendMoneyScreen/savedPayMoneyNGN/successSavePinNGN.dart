...
class SuccessSavePinNGN extends StatefulWidget {
  String? BName;
  SuccessSavePinNGN(this.BName);
  @override
  State<SuccessSavePinNGN> createState() => _SuccessSavePinNGNState();
}

class _SuccessSavePinNGNState extends State<SuccessSavePinNGN> {
  @override
            ...
            Column(
              ...
              children: [
                ...
                text1(
                    ...
                    textAlign: TextAlign.center,
                    color: Color(0xFF222222),
                    text: '\t\tPayment to NGN  Banks are normally instant, but may\t\t\ntake up to 24hrs',
                    fontWeight: FontWeight.w600),
                SizedBox(
