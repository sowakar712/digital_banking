...
class SecurePinNGN extends StatefulWidget {
  String? Name;
  String Amount;
  SecurePinNGN(this.Name,this.Amount);

  @override
  State<SecurePinNGN> createState() => _SecurePinNGNState();
}

class _SecurePinNGNState extends State<SecurePinNGN> {
  String pincode="";
  String text = '';
  List<String> OTPText=['','','','','',''];
  ...
  Future transferNGNMoney() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        var res =await Get.off(()=>SuccessSavePinNGN(widget.Name));
        if(res!=null){
