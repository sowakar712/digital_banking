...
import '../newPayMoneyNGN/securePinNGN.dart';
class ViewDetailsNGN extends StatefulWidget {
  String? Name;
  String? AccountNumber;
  String? SortCode;
  String? Reference;
  String? isCompany;
  ViewDetailsNGN(this.Name,this.AccountNumber,this.SortCode,this.Reference,this.isCompany);

  @override
  State<ViewDetailsNGN> createState() => _ViewDetailsNGNState();
}

class _ViewDetailsNGNState extends State<ViewDetailsNGN> {
