...
class StaticRequestMoney extends StatefulWidget {
  const StaticRequestMoney({Key? key}) : super(key: key);

  @override
  State<StaticRequestMoney> createState() => _StaticRequestMoneyState();
}

class _StaticRequestMoneyState extends State<StaticRequestMoney> {
