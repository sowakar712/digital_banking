...
class ConfirmSecurePin extends StatefulWidget {
  String CreatePin;
  ConfirmSecurePin(this.CreatePin);

  @override
  State<ConfirmSecurePin> createState() => _ConfirmSecurePinState();
}

class _ConfirmSecurePinState extends State<ConfirmSecurePin> {
  String pincode="";
  String text = '';
  List<String> OTPText=['','','','','',''];
  ...
  Future transactionPin()async{
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        Get.off(
            SecurePinOTP(hash:hash,security_info: security_info),
