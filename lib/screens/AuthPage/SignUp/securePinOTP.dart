...
class SecurePinOTP extends StatefulWidget {
  String hash;
  String security_info;

  SecurePinOTP({Key? key,required this.hash,required this.security_info}) : super(key: key);

  @override
  State<SecurePinOTP> createState() => _SecurePinOTPState();
}

class _SecurePinOTPState extends State<SecurePinOTP> {
